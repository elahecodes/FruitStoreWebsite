...
const Questions = () => {
  ...
  return (
    <section className="w-full flex flex-row justify-between items-start gap-2 md:mt-28 pb-20">
      <div className="lg:w-1/2 w-full flex flex-col gap-2">
        <div className="w-full flex justify-start items-end gap-2 text-neutral-700 mb-4">
          <img className="w-2 md:w-3 mb-2" src={iconTitle} alt="" />
          <h3 className="md:text-3xl font-bold font-lalezar">سوالات مشتریان</h3>
        </div>
        {data.map((item, index) => {
          return (
            <div key={item.id}>
              <button
                ...
                className="w-full h-16 bg-green-primery/20 lg:bg-green-primery/50 flex justify-start items-center cursor-pointer p-2 rounded-xl text-neutral-800 font-bold gap-2"
              >
                <img className="w-6" src={questionIcon} alt="" />
                {item.question}
              </button>

              <div
                className={`w-full overflow-hidden transition-all duration-300 ${
                  openIndex === index ? "h-26" : "h-0"
                }`}
              >
                <p className="w-full rounded-xl bg-neutral-100 mt-2 border border-neutral-200 p-2">
                  {item.answer}
                </p>
              </div>
            </div>
      ...
      <div className="lg:w-1/2 hidden lg:flex justify-center items-start">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="500"
          height="676.854"
          viewBox="0 0 1000 676.854"
        ...
        >
          <g transform="translate(-537.662 -242.369)">
            <circle
              ...
              cy="52.28"
              r="52.28"
              transform="translate(975.673 812.908)"
              fill="#ffa500"
            />
            <path
              ...
              transform="translate(376.883 96.403)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(653.466 294.081)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(842.699 345.794)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(1002.95 242.369)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(1102.964 358.295)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(967.717 492.406)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(796.101 557.188)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(977.946 658.34)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(1173.429 715.166)"
              fill="#f2f2f2"
            />
            <circle
              cx="27.277"
              cy="27.277"
              r="27.277"
              transform="translate(1401.872 702.664)"
              fill="#f2f2f2"
            />
            <path
            ...
            <path
              ...
              transform="translate(400.168 106.786)"
              fill="#3f3d56"
            />
            <path
              ...
              transform="translate(411.47 106.798)"
              fill="#3f3d56"
            />
            <path
            ...
            <g transform="translate(1135.87 516.267)">
              ...
              <ellipse
                ...
                rx="18.799"
                ry="18.799"
                transform="translate(31.706 8.004)"
                fill="#f8a8ab"
              />
              <path
                ...
                transform="translate(-205.287 -35.364)"
                fill="#2f2e43"
              />
              <path
                ...
                transform="translate(-212.925 -40.764)"
                fill="#2f2e43"
              />
              <rect
                width="17.668"
                height="25.068"
                transform="translate(43.138 361.184)"
                fill="#f8a8ab"
              />
              <path
                ...
                transform="translate(-200.501 -104.397)"
                fill="#2f2e43"
              />
              <rect
                width="17.668"
                height="25.068"
                transform="translate(96.126 350.822) rotate(-31.95)"
                fill="#f8a8ab"
              />
              <path
                ...
                transform="translate(-214.303 -101.035)"
                fill="#2f2e43"
              />
              <path
                ...
                transform="translate(-202.57 -63.427)"
                fill="#2f2e43"
              />
              <path
                d="M300.993,199.491H222.43L245.995,97.92h34.233Z"
                transform="translate(-202.57 -45.138)"
                fill="#2f2e43"
              />
              <path
                ...
                transform="translate(-198.893 -42.416)"
                fill="#f8a8ab"
              />
              <path
                ...
                transform="translate(-199.215 -45.136)"
                fill="#2f2e43"
              />
              <path
            ...
            <g transform="translate(606.503 502.092)">
              <path
                ...
                transform="translate(-746.5 -229.103)"
                fill="#ed9da0"
              />
              <path
                d="M729.219,464.214,725.933,490.5l19.058,1.315,1.969-27.6Z"
                transform="translate(-670.628 -94.732)"
                fill="#ed9da0"
              />
              <path
                ...
                transform="translate(-804.773 -285.719)"
                fill="#2f2e43"
              />
              <path
                d="M789.36,464.615,786.072,490.9l19.059,1.315,1.969-27.6Z"
                transform="translate(-780.058 -94.804)"
                fill="#ed9da0"
              />
              <path
                ...
                transform="translate(-914.194 -285.791)"
                fill="#2f2e43"
              />
              <path
              ...
              <ellipse
                ...
                rx="20.373"
                ry="20.373"
                transform="translate(39.531 10.343)"
                fill="#ed9da0"
              />
              <path
                ...
                transform="translate(-843.147 -214.555)"
                fill="#e6e6e6"
              />
              <path
                ...
                transform="translate(-922.244 -227.791)"
                fill="#ed9da0"
              />
              <path
                ...
                transform="translate(-932.102 -218.378)"
                fill="#e6e6e6"
              />
              <path
              ...
              <path
                ...
                transform="translate(-173.513 -332.917)"
                fill="#3f3d56"
              />
            </g>
          </g>
