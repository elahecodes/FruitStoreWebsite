...
const Header = () => {
  ...
  return (
    ...
    ${
      ...
      <nav className="w-full px-2 md:px-8 md:shadow-2xl h-24 mx-auto flex justify-between items-center md:fixed md:top-0 md:right-0 md:bg-white z-20">
        <form className="md:hidden w-[83%] h-9" action="">
          <input
            className="md:hidden w-full h-full bg-neutral-200 border border-neutral-300 rounded-md px-2 text-xs outline-none"
        ...
        <button className="md:hidden relative border border-neutral-300 h-9 w-9 flex justify-center items-center rounded-md cursor-pointer bg-neutral-200">
          <svg fill="#404040" viewBox="0 0 24 24" width="20" height="20">
